...
var require_vue_moment = __commonJS({
  "node_modules/vue-moment/dist/vue-moment.js"(exports, module) {
    (function(global2, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : factory(global2.vueMoment = {});
      ...
      var moment = createCommonjsModule(function(module2, exports3) {
        ...
        (function(global2, factory) {
          _typeof2(exports3) === "object" && true ? module2.exports = factory() : false ? (void 0)(factory) : global2.moment = factory();
          ...
          function addParseToken(token2, callback) {
            ...
            if (isNumber(callback)) {
              func = function func2(input, array) {
          ...
          function loadLocale(name) {
            var oldLocale = null;
            if (!locales[name] && true && module2 && module2.exports) {
              try {
          ...
          getSetGlobalLocale("en", {
            ...
            ordinal: function ordinal2(number) {
      ...
      var vueMoment = {
        install: function install(Vue, options) {
          ...
          Vue.filter("moment", function() {
            ...
            function parse() {
              var arguments$12 = arguments;
              for (var _len2 = arguments.length, args2 = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
                args2[_key2] = arguments$12[_key2];
              }
              args2 = Array.prototype.slice.call(args2);
              var method = args2.shift();
              switch (method) {
                case "add": {
                  var addends = args2.shift().split(",").map(Function.prototype.call, String.prototype.trim);
                  var obj = {};
                ...
                case "subtract": {
                  var subtrahends = args2.shift().split(",").map(Function.prototype.call, String.prototype.trim);
                  var _obj = {};
                ...
                case "from": {
                  ...
                  if (moment$$1(args2[0]).isValid()) {
                    from = moment$$1(args2.shift());
                  }
                  if (args2[0] === true) {
                    args2.shift();
                    removeSuffix = true;
                ...
                case "diff": {
                  ...
                  var float = false;
                  if (moment$$1(args2[0]).isValid()) {
                    referenceTime = moment$$1(args2.shift());
                  } else if (args2[0] === null || args2[0] === "now") {
                    args2.shift();
                  }
                  if (args2[0]) {
                    units = args2.shift();
                ...
                case "calendar": {
                  ...
                  var formats = {};
                  if (moment$$1(args2[0]).isValid()) {
                    _referenceTime = moment$$1(args2.shift());
                  } else if (args2[0] === null || args2[0] === "now") {
                    args2.shift();
                  }
                  if (_typeof(args2[0]) === "object") {
                    formats = args2.shift();
                  }
      ...
      exports2["default"] = vueMoment;
      exports2.install = vueMoment_1;
...
// dep:vue-moment
var vue_moment_default = require_vue_moment();
export {
  vue_moment_default as default
};
//! moment.js
//# sourceMappingURL=vue-moment.js.map
